...
public class VarInt extends BasicEntity {
	...
	public void disableValue(int v){
		if(v < _min || v > _max){
			System.out.println("VarInt.disableValue -> exception, value " + v + " is out of bound " + _min + "src/main" + _max);
			assert(false);
		}
	...
	public void enableValue(int v){
		if(v < _min || v > _max){
			System.out.println("VarInt.enableValue -> exception, value " + v + " is out of bound " + _min + "src/main" + _max);
			assert(false);
		}
	...
	public boolean isValue(int v){ 
		if(v < _min || v > _max){
			System.out.println("VarInt.isValue -> exception, value " + v + " is out of bound " + _min + "src/main" + _max);
			assert(false);
		}
